...
export const dictionaries: Record<Locale, Dictionary> = {
  nl: {
    ...
    legal: {
      ...
      termsBody: [
        "Deze algemene voorwaarden zijn van toepassing op alle bijlesafspraken tussen Luca Aydogmus (Bijles met Luca) en de ouder, verzorger of leerling die de bijles afneemt.",
  ...
  en: {
    ...
    legal: {
      ...
      termsBody: [
        "These terms apply to all tutoring arrangements between Luca Aydogmus (Bijles met Luca) and the parent, guardian, or student receiving tutoring.",
